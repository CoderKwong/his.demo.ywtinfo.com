...
$list = select($sql); 
$multipage = multipage($pageCountNum,$page,"&act=report&op=list");

?> 
 <form action="?act=report" method="post">
  <div class="form-group">  
	...
	<tr>
                        ...
                        <td> 
                        <?php  if($v['clinicFlag']==0){ ?>
							<a href="<?php echo U(array('act'=>'report','op'=>'edit','id'=>$v['id']))?>">出报告</a>	
							<?php }else{ ?>
							 <a href="<?php echo U(array('act'=>'clinicFlag','op'=>'edit','id'=>$v['id']))?>">未就诊请前往开单</a>
						<?php } ?>
						</td>
