...
<div class="container-fluid" style="background:white;height:100%;">
    <div class="row" style="height:100%;">
        ...
        <span style="position: relative;top:-3px;">HIS Manager <span style="font-size:12px;position:relative;top:-13px;">&nbsp;<?php echo C('version->no')?></span>
                </a>
                </span>
            </div>
            <?php
