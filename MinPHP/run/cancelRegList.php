...
$list = select($sql); 
$multipage = multipage($pageCountNum,$page,"&act=cancelReg&op=list");

?> 
 <form action="?act=cancelReg&op=list" method="post">
  <div class="form-group">  
	...
	<tr>
                        ...
                        <td><a href="<?php echo U(array('act'=>'cancelReg','type'=>'do','id'=>$v['id'],'info'=>"'患者：".$v['patName']." 医生：".$v['doctorName']." 就诊日期：".$v['admitDate']."'"))?>">退号操作</a></td>
